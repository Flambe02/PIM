export const liensKaraoke = [
  ...
  },
  {
    ...
    youtube_video_id: "bL4vB-8pI8Y",
    spotify_url: null,
    apple_music_url: null,
    youtube_music_url: null,
  },
  // Vous pouvez ajouter d'autres chansons ici en suivant le même format.
  // Pour trouver l'ID de la vidéo YouTube :
  // 1. Allez sur la vidéo YouTube
  // 2. Regardez l'URL dans la barre d'adresse
  // 3. Copiez la partie après "v=" (par exemple, pour https://www.youtube.com/watch?v=dQw4w9WgXcQ, l'ID est dQw4w9WgXcQ)
]; 